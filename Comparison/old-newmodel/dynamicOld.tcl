source buildInelasticModelOld.tcl;
...
recorder Node -file tmp/nodeAcc_dynamic.txt -node 12 22 32 -dof 1 accel 
recorder Node -file tmp/nodeReaction_dynamic.txt -node 11 21 31 -dof 1 2 reaction 
puts "Starting Dynamic analysis"; 
set accelSeries "Series -dt 0.0100 -filePath gmr1.tcl -factor 15 "
...
while {$ok == 0} { 
    ...
    set Ndisp [nodeDisp 12 1]  
    set maxDisp [tcl::mathfunc::max [tcl::mathfunc::abs [lindex $Ndisp 0]] $maxDisp] 
