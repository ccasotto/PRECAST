...
fprintf(file,'set iGMfile "gmr0.tcl gmr1.tcl" ;		# ground-motion filenames, should be different files\n');
fprintf(file,'set iGMdirection "2 1";			# ground-motion direction\n');
fprintf(file,'set iGMfact "%1.2f %1.2f"; \n', factor*fz,factor*fx);
