function asset = sampleGeometry2D_v2(type,preCode,s,friction)
 ...
 if type == 1
    ...
    asset.noStoreys = 1;
	asset.noBayZ = 0;
%	asset.noBayZ = round(sampleTruncLognrml(8,22.8,2,15));	
    asset.noBays = 2;
%	asset.noBays = randsample([1 2 3],1,true,[0.5 0.4 0.1]);
...
% 	asset.noBayZ = round(sampleTruncLognrml(3,0.5,2,5));
...
% 		end
    ...
    asset.euc = 0.01;
	% Confinement factor is 1.15, strains are not changed because hoops are not 135 degree closed
