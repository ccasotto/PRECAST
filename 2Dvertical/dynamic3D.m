...
fprintf(file,'recorder Node -file nodeDisp_dynamic.txt -node $IDctrlNode -dof 1 disp \n');
fprintf(file,'recorder Node -file nodeReaction_dynamic.txt -nodeRange $SupportNodeFirst $SupportNodeLast -dof 1 2 reaction \n');
