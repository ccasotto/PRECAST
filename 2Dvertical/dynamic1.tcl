...
recorder Node -file nodeDisp_dynamic.txt -node 2 -dof 1 disp 
recorder Node -file nodeReaction_dynamic.txt -node 1 -dof 1 reaction 
set IDloadTag 400;	# for uniformSupport excitation
set iGMfile "gmr1.tcl" ;		# ground-motion filenames, should be different files
