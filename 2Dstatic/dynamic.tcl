...
recorder Node -file nodeDisp_dynamic.txt -node 12 -dof 1 disp 
recorder Node -file nodeReaction_dynamic.txt -node 11 21 31 -dof 1 2 reaction
puts "Starting Dynamic analysis"; 
set accelSeries "Series -dt 0.0100 -filePath gmr1.tcl -factor 9.81 "
