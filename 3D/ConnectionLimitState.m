...
%% Case 1: Corbel	
    ...
    Nrkc0=(7.2*sqrt(asset.Fc)*(heff*1000)^1.5)/1000;
    Nrkc=2*Nrkc0;
    ...
    pecv=1;
    pucrv=1.2;
    Vrkc0=(0.45*sqrt(dnom)*(heff*1000/dnom)^0.2*sqrt(asset.Fc)*(c1*1000)^1.5)/1000;
    A0cv=(4.5*(c1)^2);
...
%% Case 2:"Forcella"(Fork)
    ...
    pecv = 1;
    pucrv = 1.2;
    Vrkc0 =(0.45*sqrt(dnom)*(SpF*1000/dnom)^0.2*sqrt(asset.Fc)*(c1*1000)^1.5)/1000;
